      ...
      <div className="max-w-md w-full text-center space-y-6">
        ...
        <div className="space-y-2">
          ...
          {creditsAdded > 0 ? (
            ...
            <p className="text-muted-foreground text-base">
              Your subscription is now active. Enjoy unlimited AI comparisons, self-critiques, and the full verdict.
            </p>
          )}
        </div>
        ...
        <div className="flex flex-col sm:flex-row gap-3 justify-center pt-2">
          ...
          <Button variant="outline" onClick={() => navigate(`${base}/pricing`)}>
            View your plan
          </Button>
        </div>
      </div>
